...
def tokenize_and_stem(text):
    ...
    tokens = [y for text in nltk.sent_tokenize(text) for y in nltk.word_tokenize(sent_tokenized[0])]
...
tfidf_vectorizer = TfidfVectorizer(max_df=1.1, max_features=200000,
